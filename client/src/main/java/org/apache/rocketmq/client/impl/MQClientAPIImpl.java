...
public class MQClientAPIImpl {
     ...
     *
     * @param addr 消息服务器地址
     * @param requestHeader 拉取消息请求头
     * @param timeoutMillis 请求超时时间（毫秒）
     * @param communicationMode 通信模式（单向、异步、同步）
     * @param pullCallback 拉取消息回调函数
     * @return 拉取消息的结果
     * @throws RemotingException 远程通信异常
     * @throws MQBrokerException 消息队列代理异常
     * @throws InterruptedException 线程中断异常
     ...
     *
     * @param addr                     消息代理的地址
     * @param requestHeader            请求头，包含消费者组名等信息
     ...
     * @param remark 备注信息
     * @param timeoutMillis 超时时间（毫秒）
     * @throws RemotingException 如果发生远程通信异常，抛出此异常
     ...
     * @param requestBody       请求体，包含需要锁定的消息队列信息
     * @param timeoutMillis     请求超时时间（毫秒）
     * @return 锁定成功的消息队列集合
     * @throws RemotingException        远程调用异常
     ...
     *
     * @param addr 消息队列地址
     * @param requestBody 请求体，包含需要解锁的消息队列信息
     * @param timeoutMillis 请求超时时间，单位：毫秒
     * @param oneway 是否为单向请求
     ...
     * @throws InterruptedException         线程中断异常
     * @throws RemotingTimeoutException     远程通信超时异常
     * @throws RemotingSendRequestException 远程通信发送请求异常
     * @throws RemotingConnectException     远程通信连接异常
     */
    public TopicRouteData getTopicRouteInfoFromNameServer(final String topic, final long timeoutMillis,
                                                          boolean allowTopicNotExist) throws MQClientException, InterruptedException, RemotingTimeoutException, RemotingSendRequestException, RemotingConnectException {
        GetRouteInfoRequestHeader requestHeader = new GetRouteInfoRequestHeader();
        requestHeader.setTopic(topic);
        // 生产者向NameServer获取路由信息
